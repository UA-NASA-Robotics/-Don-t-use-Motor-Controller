...
#define MAXRPM		 7000 //3080 is safe value printed on motors, can probably push this up to 4000 without worry if needed.
...
#define  SET_FEEDBACK_RESOLUTION    0x3962, 0x00, 1000
